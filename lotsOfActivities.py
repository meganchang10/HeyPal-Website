...
Activity1 = Activity(fullName = "Hike @ Seven Falls", name = "Hike", location = "Seven Falls", lat = lat, lng = lng, venue_id = venue_id, image = "http://www.mountainsidenorthstar.com/wp-content/uploads/2015/10/hiking-featured.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = True, tag_free = True, tag_outdoor = True, tag_special = False, tag_learn = False, tag_date_night = True, tag_over_21= False, tag_after_work = False)
session.add(Activity1)
session.commit()
...
lng = "-119.700534"
venue_id = "4b12f540f964a5209d9123e3"
Activity1 = Activity(fullName = "Cooking Class @ Tab La Sur", name = "Cooking Class", location = "Tab La Sur", lat = lat, lng = lng, venue_id = venue_id, image = "https://thoughtsfromajoy.files.wordpress.com/2012/05/slaytor_j_01.jpg", description = "This week, we are making Paella!", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = False, tag_outdoor = False, tag_special = False, tag_learn = True, tag_date_night = True, tag_over_21= False, tag_after_work = True)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Watch Movie @ Arlington Theater", name = "Watch a Movie", location = "Arlington Theater", lat = lat, lng = lng, venue_id = venue_id, image = "https://pbs.twimg.com/media/CGXAx_KWwAEnDqV.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = False, tag_outdoor = False, tag_special = False, tag_learn = False, tag_date_night = True, tag_over_21= False, tag_after_work = True)
session.add(Activity1)
session.commit()
...
lng = "-119.855228"
venue_id = venue_id
Activity1 = Activity(fullName = "Trivia Night @ Woodstocks", name = "Trivia Night", location = "Woodstocks", lat = lat, lng = lng, venue_id = venue_id, image = "http://cdn.funcheap.com/wp-content/uploads/2014/03/736672_490143327691271_935167735_o1.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = True, tag_outdoor = False, tag_special = False, tag_learn = False, tag_date_night = True, tag_over_21= False, tag_after_work = True)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Sample Run @ Costco", name = "Sample Run", location = "Costco", lat = lat, lng = lng, venue_id = venue_id, image = "https://theamericangenius.com/wp-content/uploads/2014/10/costco-samples.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0,        tag_sporty = False, tag_free = True, tag_outdoor = False, tag_special = False, tag_learn = False, tag_date_night = False, tag_over_21= False, tag_after_work = True)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Bike @ Padaro Beach", name = "Bike", location = "Padaro Beach", lat = lat, lng = lng, venue_id = venue_id, image = "https://peloponnese.events/wp-content/uploads/2016/02/Bike-ride-photo.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = True, tag_free = True, tag_outdoor = True, tag_special = False, tag_learn = False, tag_date_night = False, tag_over_21= False, tag_after_work = False)
session.add(Activity1)
session.commit()
...
lng = "-119.548594"
venue_id = "4ba7e90af964a520ebbd39e3"
Activity1 = Activity(fullName = "Beach Day @ Padaro Beach",name = "Beach Day", location = "Padaro Beach", lat = lat, lng = lng, venue_id = venue_id, image = "http://cdn.hercampus.com/s3fs-public/2015/05/02/beach-friends2.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = True, tag_outdoor = True, tag_special = False, tag_learn = False, tag_date_night = False, tag_over_21= False, tag_after_work = False)
session.add(Activity1)
session.commit()
...
lng = "-119.69934519999998"
venue_id = "4b12f540f964a5209d9123e3"
Activity1 = Activity(fullName = "BBQ @ Leadbetter Park", name = "BBQ", location = "Leadbetter Park", lat = lat, lng = lng, venue_id = venue_id, image = "http://www.improvementscatalog.com/RoomForImprovements/wp-content/uploads/2015/05/bbq_party.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = False, tag_outdoor = True, tag_special = True, tag_learn = False, tag_date_night = False, tag_over_21= False, tag_after_work = True)
session.add(Activity1)
session.commit()
...
lng = "-119.720438"
venue_id = "4c30fa2e3896e21ea05de690"
Activity1 = Activity(fullName = "Farmer's Market @ State Street", name = "Farmer's Market", location = "State Street", lat = lat, lng = lng, venue_id = venue_id, image = "http://l7.alamy.com/zooms/4203bfb0eea1484583544999dbf79f11/people-shopping-at-the-santa-barbara-farmers-market-eaw2y8.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = True, tag_outdoor = True, tag_special = False, tag_learn = False, tag_date_night = True, tag_over_21= False, tag_after_work = True)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Play Pool @ Dargan's", name = "Play Pool", location = "Dargan's", lat = lat, lng = lng, venue_id = venue_id, image = "http://mccluresmagazine.com/wp-content/uploads/2015/05/the-game-bangkok-pool-table-tourists-sportsbar.png", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = True, tag_outdoor = False, tag_special = False, tag_learn = True, tag_date_night = False, tag_over_21= False, tag_after_work = True)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Bonfire @ Sands Beach", name = "Bonfire", location = "Sands Beach", lat = lat, lng = lng, venue_id = venue_id, image = "http://www.myabundantlife.org/wp-content/uploads/2016/09/bonfire-marshmallows.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = True, tag_outdoor = True, tag_special = True, tag_learn = False, tag_date_night = False, tag_over_21= False, tag_after_work = True)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Be a Tourist @ SB Courthouse", name = "Be a Tourist", location = "SB Courthouse", lat = lat, lng = lng, venue_id = venue_id, image = "http://santabarbaragreetingcards.com/wp-content/uploads/2015/09/sunkengarden2b-ricepapervig-cetrspotnormal-web2.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = True, tag_outdoor = True, tag_special = False, tag_learn = True, tag_date_night = False, tag_over_21= False, tag_after_work = False)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Look @ Coronado Butterfly Reserve", name = "Look", location = "Coronado Butterfly Reserve", lat = lat, lng = lng, venue_id = venue_id, image = "https://fthmb.tqn.com/ghXwRdOx1ah3hEVa4ycaBUeTILY=/2122x1415/filters:fill(auto,1)/about/GettyImages-513055973-573ba3a05f9b58723dd73854.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = True, tag_outdoor = True, tag_special = False, tag_learn = False, tag_date_night = True, tag_over_21= False, tag_after_work = False)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Feed Giant Birds @ Ostrich Land", name = "Feed Giant Birds", location = "Ostrich Land", lat = lat, lng = lng, venue_id = venue_id, image = "http://californiathroughmylens.com/wp-content/uploads/2011/10/Ostriches-next-to-bite-sign.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = True, tag_outdoor = True, tag_special = True, tag_learn = False, tag_date_night = True, tag_over_21= False, tag_after_work = False)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Jump off the Pier @ Goleta Beach", name = "Jump off the Pier", location = "Goleta Beach", lat = lat, lng = lng, venue_id = venue_id, image = "http://hanaleiholiday.com/wp-content/uploads/2014/02/boys-pier-jump.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = True, tag_outdoor = True, tag_special = True, tag_learn = False, tag_date_night = False, tag_over_21= False, tag_after_work = False)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Wine Tasting @ Deep Sea Tasting Room", name = "Wine Tasting", location = "Deep Sea", lat = lat, lng = lng, venue_id = venue_id, image = "https://media-cdn.tripadvisor.com/media/photo-s/07/8b/79/e7/another-great-shot.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = False, tag_outdoor = True, tag_special = False, tag_learn = False, tag_date_night = True, tag_over_21= True, tag_after_work = True)
session.add(Activity1)
session.commit()
...
Activity1 = Activity(fullName = "Appetizers @ Milk & Honey", name = "Appetizers", location = "Milk & Honey", lat = lat, lng = lng, venue_id = venue_id, image = "http://urbandiningguide.com/wp-content/uploads/2015/11/milkhoneysantabarbara.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = False, tag_outdoor = True, tag_special = False, tag_learn = False, tag_date_night = True, tag_over_21= False, tag_after_work = True)
session.add(Activity1)
session.commit()
...
lng = "-119.6855694999"
venue_id = "4e220b75fa761d671082ff1b"
Activity1 = Activity(fullName = "Dancing @ O'Malley's", name = "Dancing", location = "O'Malley's", lat = lat, lng = lng, venue_id = venue_id, image = "http://www.retale.com/blog/shared/content/uploads/2016/02/dive-bar-3.jpg", id = id_key, creator =1, log_views = 0, adds_to_myActivities = 0, tag_sporty = False, tag_free = False, tag_outdoor = True, tag_special = False, tag_learn = False, tag_date_night = True, tag_over_21= True, tag_after_work = True)
session.add(Activity1)
session.commit()
